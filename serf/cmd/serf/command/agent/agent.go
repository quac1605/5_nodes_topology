...
// Print the gossip interval before joining
    if a.conf.MemberlistConfig != nil {
        a.logger.Printf("[INFO] agent: joining with Gossip Interval: %v", a.conf.MemberlistConfig.GossipInterval)
    }
